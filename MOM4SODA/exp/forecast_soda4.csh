...
set name          = SODA4
set platform      = derecho     # A unique identifier for your platform
...
set diagtable     = $inputDataDir/diag_table_forecast  # path to diagnositics table
...
set namelist      = $inputDataDir/input_forecast.nml   # path to namelist file

#set executable    = $root/exec/$platform/$type/fms_$type.x      # executable created after compilation
set executable    = /glade/u/home/chepurin/scratch/MOM5_COMP/exec_test/derecho/MOM_SIS/fms_MOM_SIS.x
...
# remove restart files because it will not be used 
  rm -f RESTART/*
  cd $expdir
  mkdir history
  mkdir ascii
#----------------------------------------------------------------------------------------------
# rename ascii files with the date and move to the ascii directory
  foreach out (`ls *.out`)
...
#----------------------------------------------------------------------------------------------
# rename nc files with the date and move it to the history directory
