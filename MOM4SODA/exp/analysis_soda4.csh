...
set diagtable     = $inputDataDir/diag_table_analysis  # path to diagnositics table
...
set namelist      = $inputDataDir/input_analysis.nml   # path to namelist file

#set executable    = $root/exec/$platform/$type/fms_$type.x      # executable created after compilation
#set executable    = /glade/work/chepurin/MOM5_RARE/exec/$platform/$type/fms_$type.x      # executable created after compilation
...
# move nc files to the history directory
