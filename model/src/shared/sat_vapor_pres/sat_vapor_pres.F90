...
!#######################################################################
 ...
 integer :: i, unit
   ...
   unit = stdout()
   write(unit,*) 'Bad temperatures from 1d (dimension 1): ', (check_1d(temp(i:i)),i=1,size(temp,1))
...
!--------------------------------------------------------------
 ...
 integer :: i, j, unit
   ...
   unit = stdout()
   write(unit,*) 'Bad temperatures from 2d (dimension 1): ', (check_1d(temp(i,:)),i=1,size(temp,1))
   write(unit,*) 'Bad temperatures from 2d (dimension 2): ', (check_1d(temp(:,j)),j=1,size(temp,2))
...
!--------------------------------------------------------------
 ...
 integer :: i, j, k, unit
   ...
   unit = stdout()
   write(unit,*) 'Bad temperatures from 3d (dimension 1): ', (check_2d(temp(i,:,:)),i=1,size(temp,1))
   write(unit,*) 'Bad temperatures from 3d (dimension 2): ', (check_2d(temp(:,j,:)),j=1,size(temp,2))
   write(unit,*) 'Bad temperatures from 3d (dimension 3): ', (check_2d(temp(:,:,k)),k=1,size(temp,3))
